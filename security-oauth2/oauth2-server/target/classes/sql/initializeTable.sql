...
`fullname` varchar(30) NOT NULL COMMENT '用户姓名',
...
insert into `t_permission`(`id`,`code`,`description`,`url`) values ('1','p1','测试资源 1','/admin/adminDetails'),('2','p3','测试资源2','/user/userDetails');
